...
RSpec.describe RemotesController, type: :controller do
  ...
  # Remote. As you add validations to Remote, be sure to
  ...
  # RemotesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "DELETE #destroy" do
    it "destroys the requested remote" do
      remote = Remote.create! valid_attributes
      expect {
        delete :destroy, params: {id: remote.to_param}, session: valid_session
      }.to change(Remote, :count).by(-1)
    end

    it "redirects to the remotes list" do
      remote = Remote.create! valid_attributes
      delete :destroy, params: {id: remote.to_param}, session: valid_session
      expect(response).to redirect_to(remotes_url)
    end
  end
